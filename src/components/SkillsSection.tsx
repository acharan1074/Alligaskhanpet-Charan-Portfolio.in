...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['HTML', 'CSS', 'JavaScript', 'React.js', 'Next.js', 'Tailwind CSS', 'TypeScript', 'Vite'],
    description: 'Expertise in building high-performance, modular interfaces and responsive web applications with modern styling.',
    stat: '100% RESPONSIVE',
  ...
  },
  {
    ...
    badge: 'LOGIC & APIs',
    items: ['Python', 'Django', 'Node.js', 'Express.js', 'Java', 'REST APIs'],
    description: 'Developing secure server architectures, robust REST endpoints, and role-based backend workflows.',
    stat: 'SCALABLE BACKEND',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'DATABASES & CLOUD',
    badge: 'DATA LAYER',
    items: ['PostgreSQL', 'MySQL', 'MongoDB', 'SQLite', 'Firebase / Firestore'],
    description: 'Designing normalized relational schemas, NoSQL stores, and real-time database integrations.',
    stat: 'ACID & NOSQL',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'INTELLIGENCE',
    items: ['Python', 'Machine Learning', 'Deep Learning', 'OpenCV', 'Scikit-learn', 'AI Tools'],
    description: 'Hands-on development of predictive models, computer vision systems, and modern AI tool integrations.',
    stat: 'AI / ML READY',
    colSpan: 'lg:col-span-7',
  },
  {
    title: 'TOOLS & DATA ANALYTICS',
    badge: 'WORKFLOW & OPS',
    items: ['Git', 'GitHub', 'Power BI', 'Data Analysis', 'Responsive Design', 'App Hosting'],
    description: 'Proficient in version control, data visualization, business intelligence reporting, and full lifecycle deployment.',
    stat: 'END-TO-END',
    colSpan: 'lg:col-span-7',
  },
  {
    ...
    badge: 'GLOBAL REACH',
    items: ['English (Proficient)', 'Telugu (Native)', 'Hindi (Proficient)', 'Team Leadership'],
    description: 'Effective cross-functional communication, analytical problem solving, and collaborative project execution.',
    stat: '3 LANGUAGES',
    colSpan: 'lg:col-span-5',
  },
];
