          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL-STACK DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> AI &amp; ML ENTHUSIAST <span className="text-[#8C6D4F] mx-1">•</span> SOFTWARE ENGINEER
              </p>
            </motion.div>
            ...
            >
              <p>
                B.Tech graduate in CSE (AI &amp; ML). Building practical, scalable, and responsive web applications, business platforms, and intelligent AI-powered solutions.
              </p>
            </motion.div>
