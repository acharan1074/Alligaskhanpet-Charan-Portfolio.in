        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xs sm:text-sm md:text-[14px] font-light text-[#B3A497] leading-[1.85] tracking-wide mb-6 max-w-xl"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I&apos;m <span className="text-[#F3DBB3] font-medium">Alligaskhanpet Charan</span>, a Computer Science &amp; Engineering graduate specializing in <span className="text-[#F3DBB3] font-medium">AI &amp; Machine Learning</span> from St. Mary&apos;s Group of Institutions, Hyderabad (Affiliated to JNTU Hyderabad). As a passionate Full-Stack Developer, I build responsive, scalable web applications, mobile platforms, and AI-powered software solutions for real-world impact.
            </motion.p>

            {/* What I Do Chips */}
            <motion.div variants={fadeUpVariants} className="flex flex-wrap gap-1.5 mb-8 max-w-xl">
              {[
                'Full-Stack Web Dev',
                'Mobile Apps',
                'AI/ML Solutions',
                ...
                <span
                  key={pill}
                  className="px-2.5 py-1 text-[9.5px] font-mono tracking-wider uppercase border border-[#8C6D4F]/30 bg-[#120F0C] text-[#C4B29E] rounded-sm"
                >
                  {pill}
                </span>
              ))}
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                {/* Main Portrait */}
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-09-06%20at%2021.41.54-ZgsB133oxyQ1hn7pU3bwDaTelZqifZ.jpeg"
                  alt="Alligaskhanpet Charan in a formal suit"
