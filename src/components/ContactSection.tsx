      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Open to full-time opportunities, freelance projects, collaborations, internships, and software development. If you have an idea, I&apos;m ready to help turn it into a working digital product.
              </p>

              {/* Direct Channels */}
              <div className="space-y-4">
                <a
                  href="mailto:acharan1074@gmail.com"
                  className="flex items-center space-x-3 p-3.5 rounded-sm border border-[#8C6D4F]/30 bg-[#0E0C0A] hover:border-[#D4AF37] hover:bg-[#15110E] transition-all group"
                >
                  <span className="text-xs font-mono text-[#D4AF37]">EMAIL //</span>
                  <span className="text-xs font-mono text-[#E8DFD8] group-hover:text-white transition-colors">
                    acharan1074@gmail.com
                  </span>
                </a>
                ...
                <a
                  ...
                  className="flex items-center space-x-3 p-3.5 rounded-sm border border-[#8C6D4F]/30 bg-[#0E0C0A] hover:border-[#D4AF37] hover:bg-[#15110E] transition-all group"
                >
                  <span className="text-xs font-mono text-[#D4AF37]">PHONE //</span>
                  <span className="text-xs font-mono text-[#E8DFD8] group-hover:text-white transition-colors">
                    +91-9705309630
                  </span>
                </a>

                <div className="flex items-center space-x-3 p-3.5 rounded-sm border border-[#8C6D4F]/30 bg-[#0E0C0A]">
                  <span className="text-xs font-mono text-[#D4AF37]">LOC //</span>
                  <span className="text-xs font-mono text-[#E8DFD8]">
                    Hyderabad, Telangana
                  </span>
                </div>

                <a
                  href="https://github.com/acharan1074"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between p-3.5 rounded-sm border border-[#8C6D4F]/30 bg-[#0E0C0A] hover:border-[#D4AF37] hover:bg-[#15110E] transition-all group"
                >
                  <span className="text-xs font-mono text-[#D4AF37]">GITHUB //</span>
                  <span className="text-xs font-mono text-[#E8DFD8] group-hover:text-white transition-colors">
                    acharan1074 ↗
                  </span>
                </a>
                ...
                <a
                  href="https://www.linkedin.com/in/alligaskhanpet-charan-6289232ab"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between p-3.5 rounded-sm border border-[#8C6D4F]/30 bg-[#0E0C0A] hover:border-[#D4AF37] hover:bg-[#15110E] transition-all group"
                >
                  <span className="text-xs font-mono text-[#D4AF37]">LINKEDIN //</span>
                  <span className="text-xs font-mono text-[#E8DFD8] group-hover:text-white transition-colors">
                    alligaskhanpet-charan ↗
                  </span>
                </a>
              </div>
            </div>
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] uppercase">
            ALLIGASKHANPET CHARAN // PORTFOLIO
          </span>
